    ...
    <br><h3 class="text-center">{{$get_dev_profile->name}}</h3><br>
        ...
        <div class="row">
            ...
            <div class="form-group col-12">
                ...
                <img id="profile_picture" src="{{empty($get_dev_profile->profile_picture) ? asset('storage/pictures/default.png') : asset("storage/developer/$get_dev_profile->profile_picture")}}" width="150px" height="100px"
